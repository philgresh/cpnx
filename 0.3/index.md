[Source on GitHub](https://github.com/philgresh/cpnx) [cpnx on PyPI](https://pypi.org/project/cpnx/)
...
A quick-look cheatsheet of the public surface. For the complete, auto-generated reference, see the [full API reference](https://philgresh.github.io/cpnx/latest/reference/core/).
...
Contributions are welcome — see [CONTRIBUTING.md](https://github.com/philgresh/cpnx/blob/main/CONTRIBUTING.md) for development setup, the `make` targets CI runs, and the docstring/documentation conventions.
